...
public class DaoBebida {
    ...
    public void salvar(Bebida bebida) {
        String sql =
                "INSERT INTO tb_bebidas(nm_bebida, descricao, quantidade, valor_compra, valor_venda,"
                        + " tipo, fg_ativo) "
                        + "VALUES(?,?,?,?,?,?,?)";
    ...
    public void alterar(Bebida bebida) {
        String sql =
                "UPDATE tb_bebidas SET nm_bebida=?, descricao=?, quantidade=?, valor_compra=?, valor_venda=?,"
                        + " tipo=? "
                        + "WHERE id_bebida =?";
    ...
    public void remover(Bebida bebida) {
        String sql = "DELETE FROM tb_bebidas" + " WHERE id_bebida=?";
