...
public class DaoIngrediente {
    ...
    public void salvar(Ingrediente ingrediente) {
        String sql =
                "INSERT INTO tb_ingredientes(nm_ingrediente, descricao, quantidade, valor_compra, valor_venda,"
                        + " tipo, fg_ativo) "
                        + "VALUES(?,?,?,?,?,?,?)";
    ...
    public List<Ingrediente> listarTodosPorLanche(int id) {
        String sql =
                "SELECT i.id_ingrediente, i.nm_ingrediente, i.descricao, il.quantidade, "
    ...
    public void alterar(Ingrediente ingrediente) {
        String sql =
                "UPDATE tb_ingredientes SET nm_ingrediente=?, descricao=?, quantidade=?, valor_compra=?, valor_venda=?,"
                        + " tipo=? "
    ...
    public void remover(Ingrediente ingrediente) {
        ...
        String sql = "DELETE FROM tb_ingredientes" + " WHERE id_ingrediente=?";
    ...
    public Ingrediente pesquisaPorNome(Ingrediente ingrediente) {
        String sql =
                "SELECT * FROM tb_ingredientes WHERE nm_ingrediente='"
                        + ingrediente.getNome()
                        + "'";
        ResultSet rs;
