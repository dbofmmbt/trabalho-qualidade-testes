...
public class DaoRelatorio {
    ...
    public List<RelatorioLanches> listarRelLanches() {
        String sql =
                "SELECT l.nm_lanche, i.nm_ingrediente, il.quantidade,\n"
    ...
    public List<RelatorioBebidas> listarRelBebidas() {
        String sql =
                "SELECT p.id_pedido, CONCAT(c.nome,' ',c.sobrenome) as cliente, b.nm_bebida, bp.quantidade,\n"
    ...
    public List<RelatorioGastos> listarRelGastos() {
        String sql =
                "SELECT (SELECT SUM(i.valor_compra*il.quantidade*lp.quantidade)\n"
